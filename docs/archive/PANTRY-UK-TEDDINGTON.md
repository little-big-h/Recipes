# Pantry and Staples — Teddington, UK (RETIRED)

> 🗄 **RETIRED 2026-08-10.** This is the pantry of the **Teddington (West London) kitchen**, closed out when Holger moved to Singapore. **Do not design recipes against it** — the live list is `../PANTRY.md`.
>
> Kept for three reasons, all of them still useful:
>
> 1. **Product records.** The label transcriptions here (Mae Ploy vegan tom yum, HollyFarms tom yum, M&S soya drink, the mild curry powder, Israeli couscous, the alphabet noodles) are real nutrition data and stay valid for those products wherever they're bought. Several of these products are sold in Singapore too.
> 2. **Historical recipes.** Everything under `recipes/` cooked before August 2026 was designed against *this* list. When reading an old recipe's "pantry fit" note, this is the pantry it meant.
> 3. **Standing preferences that survived the move** — avocado oil ≤3 g per dish, white miso as the family default, Biona Light coconut milk as the 9%-fat reference — are restated in the live file, but their original context is here.
>
> **Dead sourcing:** Buy Whole Foods Online, M&S, Ocado and milk.co.uk are all UK-only. `../BWFO_GRAPHQL.md` still works as an API but is no longer Holger's shop.

---

What was always (or usually) in stock in the Teddington kitchen.

> ⚠ **Run-down mode (until the ~Aug 2026 Singapore move)** was in force when this file was last live: use up what's here, especially **spices and pastes** — don't buy new. **This is over.** The move happened; buying is allowed again.
...
- **Milk** — default is **semi-skimmed** (milk.co.uk values: 47 kcal, 3.6 g protein, 1.8 g fat, 124 mg calcium per 100 ml). Resolve a plain "milk" to this unless a recipe specifies whole/skimmed. See `../INGREDIENT_MAP.md`.
...
- **BWFO Seitan Flour (vital wheat gluten)** ⚠ run-down use-up priority — large stock on hand, along with excess **onions**, **corn flour** and **rice flour**. See `recipes/oven-mains/pressure-steamed-seitan-sausage.md` (dough + crisp-dredge use of all four at once). See `../INGREDIENT_MAP.md` for nutrition.
