...
| 62 | Chapati (Anja) | v1 | **Anja's cook, 2026-07-21 — recorded, not rated.** Wholemeal flatbread to go with the zucchini curry + quinoa: 340 g wholemeal flour, 2 g salt, 9 g avocado oil, 180 g water; raw dough 531 g (cooked weight not recorded — chapati sheds water on the tawa). Nutrition is cooking-loss-independent (water = 0 kcal), so totals are just flour + oil + salt: **~1236 kcal / 248 g carb / 44 g protein / 31 g fibre / 17 g fat / salt ~2 g** for the batch (~6 chapatis). **Flour valued as a UK-wholemeal label estimate, not USDA** — the two USDA whole-wheat records bracket UK wholemeal poorly (soft `168944` = low protein/high fibre; Foundation `790085` = high protein, no sugars/sat-fat), so a UK label (Allinson-class: 340 kcal, 12.8 g protein, 9 g fibre / 100 g) is the honest basis; swap the pack's real values if known. Not FoodNoms-verified. Separate file under `anjas-cooking/`. |
