...
| 48 | Creamy Tomato, Coconut & Spinach Sauce | v1 | **Follow-up (2026-07-02): 15 g nutritional yeast added (not in the original plan or remark 47), and total yield reported as 1159 g.** Spinach weight was never directly reported across either update — summing every other known ingredient (856 g) against the 1159 g yield implies ~300 g spinach, matching the ~2x scaling already seen on tofu/tomato paste/garlic; adopted as the working figure for the nutrition table (deduced, not measured — flagged in the recipe file). Final as-cooked totals: 841 kcal / 1159 g, vs. the original plan's 445 kcal / ~620 g. Get a direct spinach weight and confirm oil/salt amounts on the next cook so the table stops carrying assumptions. |
