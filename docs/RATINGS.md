...
| Butterbean, Sweet Potato & Sage Soup | European |
...
| Butterbean, Sweet Potato & Sage Soup | v1 | planned | — | [butterbean-sweetpotato-sage-soup.md](../recipes/soups/butterbean-sweetpotato-sage-soup.md) |
...
| 58 | Butterbean, Sweet Potato & Sage Soup | v1 | **Designed 2026-07-19 — family dinner, scaled for leftovers; not yet cooked/rated.** A blended butter-bean + sweet-potato base (body from bean starch, no cream/coconut — 16 g total fat), sage-led herb note (6 g dried sage + 3 g oregano, bloomed in the oil) with asparagus kept in chunks and folded in last for texture. A **pantry run-down cook** — chosen specifically to use up dried sage + oregano; a lime-leaf/lemongrass/coconut **Thai** version was considered and parked to its own future cook (lime leaf fights sage/oregano). White miso off-heat for savoury depth. Clears every family flag (no in-pot heat/smoke/peppers/acid; lemon + chilli at table) and the smooth sweet-potato base sidesteps Jannes's cool-ness on potatoes. **Scaled to the 1420 g of sweet potato actually on hand** (×1.58 from the 900 g design) → a ~4.8 kg, ~10-portion pot: **~3625 kcal / 730 g carb / 168 g protein / 174 g fibre / 16 g fat / salt 6.5 g** whole recipe (~17 g protein + ~17 g fibre per bowl; salt deliberately modest, room to lift). USDA-derived, not FoodNoms-verified — reconcile on the cook. |
