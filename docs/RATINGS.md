...
| White Bean, Sweet Potato & Sage Soup | v1 | planned | — | [white-bean-sweetpotato-sage-soup.md](../recipes/soups/white-bean-sweetpotato-sage-soup.md) |
...
| 58 | White Bean, Sweet Potato & Sage Soup | v1 | **Designed 2026-07-19 — family dinner, scaled for leftovers; not yet cooked/rated.** A blended white-bean + sweet-potato base (body from bean starch, no cream/coconut — 14 g total fat), sage-led herb note (5 g dried sage + 3 g oregano, bloomed in the oil) with asparagus kept in chunks and folded in last for texture. A **pantry run-down cook** — chosen specifically to use up dried sage + oregano; a lime-leaf/lemongrass/coconut **Thai** version was considered and parked to its own future cook (lime leaf fights sage/oregano). White miso off-heat for savoury depth. Clears every family flag (no in-pot heat/smoke/peppers/acid; lemon + chilli at table) and the smooth sweet-potato base sidesteps Jannes's cool-ness on potatoes. **Two corrections from the first draft:** beans are **white beans** not butter beans (USDA 175202 — more calcium/protein/iron, denser so +8 min cook to 30 min HP), and the 1420 g sweet potato is **unpeeled** (~1200 g flesh at ~15 % peel loss). Scaled to the 1200 g flesh (×1.33 from the 900 g design) → a ~4.1 kg, ~9-portion pot: **~3057 kcal / 606 g carb / 152 g protein / 131 g fibre / 14 g fat / salt 5.5 g** whole recipe, **calcium ~1884 mg** (white beans are calcium-dense). ~17 g protein + ~15 g fibre per bowl; salt deliberately modest, room to lift. USDA-derived, not FoodNoms-verified — reconcile on the cook. |
