...
| 40 | Vegetable & Potato Soup (Anja) | v1 | **Anja's own cook, 2026-06-15** — first dish logged under `anjas-cooking/` (her cooks now enter the ratings system too). Simple leek/celery/carrot/potato + Knorr veg cubes + parsley; 4800 g pot. **Ratings pending.** Nutrition USDA-derived + Knorr label, not FoodNoms-verified (~1553 kcal, 40 g protein, 53 g fibre, salt 15.1 g — ~13 g of it from the 40 g of stock cubes). |
...
| 18 | Creamy Butternut & Soy Bean Soup, family | **Whole soy beans don't land with the kids.** The Pinto–Butternut soup (creamy *blended* beans, mild) scored 7.7–8.0 family-wide; the near-identical Butternut & **Soy Bean** soup (whole beans + dashi/miso savoury push) cratered the kids (Julina 4.0, Jannes 5.9) and softened Anja (7.2) — the project's widest spread (4.0). The variable is the **whole soy beans**: beany flavour + firm/possibly-chalky texture (under-tender off a 5 h soak) against sweet squash. **For a family butternut-bean soup, blend the beans into the body and keep it mild/sweet (the pinto model); reserve whole-soy-bean + dashi for Holger-solo / adults.** Lara (7.3) was *fine* — not a Lara-flag issue, it's bean palatability for the younger/variance palates. |
