...
- **Za'atar, sumac**
- **Gochujang**
- **Tom yum paste — Mae Ploy *VEGAN* (orange tub, VEGAN badge, 400 g, barcode `8850367994076`)**. ✅ **This is the vegan one; it is fine to use.** Mae Ploy sells two tom yum pastes and only the *standard* one contains shrimp paste, fish sauce and dried shrimp — **do not assume Holger's jar is that one, it isn't.** Ingredients: lemongrass 38.2%, galangal 9.6%, water, shallot 6.9%, tamarind 6.4%, citric acid 5.3%, soybean oil 5.0%, salt 4.6%, garlic 4.2%, sugar 3.0%, fermented soybean paste 1.5%, hydrolyzed soy protein 1.2%, kaffir lime peel 0.4%. Contains soy; no MSG, gluten free. Label: **244 kcal, 3.4 g protein, 22 g carb (19 g sugars), 15 g fat (2.3 g sat), 4.8 g fibre, salt 13.9 g per 100 g** — ⚠ the 13.9 g salt figure doesn't reconcile with the declared 4.6% salt; treat it as a conservative upper bound and taste. Its **tamarind content covers a tamarind stock-out**, and its fermented soy + HVP supply the glutamate that the shrimp/fish version gets from seafood. Used in `recipes/stovetop-mains/tom-yum-butternut-cauliflower-curry.md`.
