...
> **Migrated from legacy Wolfram Language source** (`squash-mash-tofu-gravy.wl`). Recipe content fully migrated; nutrition values below are rough estimates pending FoodNoms verification. No family ratings on record.

> **Apple note:** the apple is used as a savoury caramelisation partner with onion (Maillard + natural sweetness), not as a fruit garnish. Categorised here as Vegetables for that reason.
...
4. From about 10 min: peel and cube 🎃 butternut squash (done by about 20 min).

5. At about 20 min: switch Ninja to pressure cook mode. Add 150 ml water, 🎃 squash on top. Seal — high pressure, 3 min, delayed release (10 min). Heat-up scales for ~1.1 kg load: 18–21 min before pressure begins.

6. At about 30 min: once 🧅 onions and 🍎 apple are deeply caramelised, add 🥄 vegetable stock, 🍷 balsamic and 🌿 thyme. Simmer 8 minutes until slightly reduced. Dissolve 🫙 white miso in a ladle of gravy and stir back in. **Do not boil after adding miso.**

7. At about 52 min: heat 🫘 Lara's beans on the hob (done by about 59 min).
