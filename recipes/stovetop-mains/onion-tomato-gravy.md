# Smooth Onion–Tomato Gravy

*A versatile, silky **base sauce**: **microwave-jumpstarted onions** sautéed to deep gold, **bhuna'd tomato paste**, then **two tins (800 g) of hand-crushed whole tomatoes** simmered down and **blended smooth**, spiced as a light Indian masala gravy. The foundation for a curry (fold in chickpeas, tofu, paneer, butternut, kofta…), a shakshuka base, or anything tomato-forward. Makes ~1.2 kg. Smooth = Lara-friendly; built mild, heat at the table.*
...
*Legend: 🟢 Vegetables · 🟡 Aromatics · 🟠 Spices / Pastes · 🟣 Seasoning · ⚪ Acid*
...
> **Prep.** **Hand-crush** the 🥫 whole tomatoes (or they break up unevenly in the simmer).

1. **Microwave the onions.** Chopped 🧅 onion in a bowl, microwave **~5–6 min** until soft and translucent — this collapses the cells so they caramelise in about half the pan time, with less oil.
2. **Sauté.** Heat the 🥑 oil in the wok, add the microwaved 🧅 onion, and sauté **~8–10 min** to deep golden.
3. **Bhuna the paste.** Stir the 🍅 tomato paste straight into the golden onions and fry **~2 min**, stirring constantly so it cooks against the hot base and darkens — no pushing aside needed in a pot. *(You can instead fry the paste in the oil first and add the onions to it, but the wet microwaved onions then steam and brown less; onions-first gives the more golden base.)*
4. **Aromatics + spices.** Add 🧄 garlic powder + 🫚 ground ginger along with the 🌰 cumin, 🌿 coriander, 🍛 garam masala, 🫑 paprika; bloom **~1 min** — the powders bloom in the oil like the other spices, so keep it moving to stop them scorching.
...
*Whole batch of sauce (~1.2 kg, no add-ins). **USDA-derived, not FoodNoms-verified** — per-ingredient USDA/label values summed in Wolfram; micros are committed best-estimates. It's a low-fat, low-protein **base** — the nutrition that matters is what you build into it. High in potassium, iron and folate from 800 g of tomato + the spices. Salt ~1.0 g is from ingredients; salted to taste at step 5.*
...
(* Vector: {kcal, prot, carb, sugar, fat, sat, fibre, salt,
   ...
   Per 100 g. *)
n100 = <|
  "onion"       -> { 40,  1.1,  9.3, 4.2, 0.1, 0.04, 1.7, 0.01, 0.21,  23, 0.17, 10, 146, 0, 0, 19},
  "avocadoOil"  -> {884,  0,    0,   0,  100, 11.6,  0,   0.00, 0,      0, 0,     0,   0, 0, 0,  0},
  "tomatoPaste" -> { 82,  4.3, 18.9,12.2, 0.5, 0.1,  4.1, 0.15, 2.98,  36, 0.63, 42,1014, 0, 0, 19},
  "garlicPwd"   -> {331, 16.55,72.73,2.43,0.73,0.249,9.0, 0.15, 5.65,  79, 2.99, 77,1193, 0, 0, 47},
  "gingerGrd"   -> {335,  8.98,71.6, 3.4, 4.24,2.6, 14.1, 0.07,19.8,  114, 3.6, 214,1320, 0, 0, 13},
  "cumin"       -> {375, 18.0, 44.0, 2.3,22.0, 1.5, 11.0, 0.17,66.0,  931, 4.8, 366,1788, 0, 0, 10},
  "corianderG"  -> {298, 12.4, 55.0, 0,  17.8, 1.0, 41.9, 0.10,16.3,  709, 4.7, 330,1267, 0, 0,  0},
  "garam"       -> {350, 12.0, 50.0, 3.0,12.0, 2.0, 25.0, 0.20,30.0,  400, 3.0, 150,1300, 0, 0, 20},
  "paprika"     -> {282, 14.0, 54.0,10.0,13.0, 2.1, 35.0, 0.07,21.0,  229, 4.3, 178,2280, 0, 0, 49},
  "cannedTom"   -> { 19,  1.1,  3.0, 3.0, 0.1, 0.02, 0.9, 0.10, 0.7,   25, 0.15,  9, 220, 0, 0, 13}
|>;
amounts = <|
  "onion" -> 405, "avocadoOil" -> 6, "tomatoPaste" -> 50, "garlicPwd" -> 4,
  "gingerGrd" -> 3, "cumin" -> 5, "corianderG" -> 6, "garam" -> 6,
...
|:------|------:|:------|------:|
| Energy | 500 kcal | Iron | 16 mg |
| Protein | 19 g | Calcium | 440 mg |
| Carbohydrates | 87 g | Zinc | 3.3 mg |
| — of which sugars | 48 g | Magnesium | 197 mg |
| Fat | 11 g | Potassium | 3280 mg |
| — of which saturates | 2 g | Vitamin D | 0.0 µg |
| Fibre | 23 g | Vitamin B12 | 0.0 µg |
| Salt | ~1.0 g | Folate | 193 µg |

*FoodNoms collection name (with creation stamp): **Smooth Onion–Tomato Gravy [30-06-26] ✴️**. **⬇ [download `.foodnoms`](https://www.wolframcloud.com/obj/pirk0/BuildFoodNomsRecipe?name=Smooth+Onion-Tomato+Gravy+%5b30-06-26%5d+%e2%9c%b4%ef%b8%8f&collectionType=3&servings=4&totalServingSize=1202&fdcIds=170000%2c170459%2c171325%2c170923%2c170922%2c171329%2c170926&grams=405%2c50%2c4%2c5%2c6%2c4%2c3&customNames=Garam+Masala%3bWhole+Canned+Tomatoes%3bAvocado+Oil&customFoodIds=local%3aGARAM%3blocal%3aCANNEDTOM%3blocal%3aAVOCADOOIL&customQuantities=6%3b800%3b6&customUnits=gram%3bgram%3bgram&customNutrientNames=calories%2cprotein%2ccarbs%2csugars%2cfat%2cfatSaturated%2cfiber%2csodium%2ciron%2ccalcium%2czinc%2cmagnesium%2cpotassium%2cvitaminD%2cvitaminB12%2cfolate%3bcalories%2cprotein%2ccarbs%2csugars%2cfat%2cfatSaturated%2cfiber%2csodium%2ciron%2ccalcium%2czinc%2cmagnesium%2cpotassium%2cvitaminD%2cvitaminB12%2cfolate%3bcalories%2cprotein%2ccarbs%2csugars%2cfat%2cfatSaturated%2cfiber%2csodium%2ciron%2ccalcium%2czinc%2cmagnesium%2cpotassium%2cvitaminD%2cvitaminB12%2cfolate&customNutrientValues=350%2c12%2c50%2c3%2c12%2c2%2c25%2c80%2c30%2c400%2c3%2c150%2c1300%2c0%2c0%2c20%3b19%2c1.1%2c3%2c3%2c0.1%2c0.02%2c0.9%2c40%2c0.7%2c25%2c0.15%2c9%2c220%2c0%2c0%2c13%3b884%2c0%2c0%2c0%2c100%2c11.6%2c0%2c0%2c0%2c0%2c0%2c0%2c0%2c0%2c0%2c0)** — generated only when clicked; **turmeric omitted (not in stock)**. 4 spices pinned to USDA SR Legacy (full micronutrient panels), only garam masala / canned tomatoes / avocado oil custom. Totals verified to this table (500 kcal, salt 0.97 g, potassium 3280 mg; HTTP 200, warnings []).*
