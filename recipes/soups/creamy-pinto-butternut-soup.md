...
XHTML Header: <script>
    (function($){
        $(function(){
            ...
            $rows.filter(':nth-child(2),:nth-child(3),:nth-child(11),:nth-child(12)').css('background-color','#d9f2d9');
            $rows.filter(':nth-child(7),:nth-child(8)').css('background-color','#fcf5cc');
            $rows.filter(':nth-child(9),:nth-child(10)').css('background-color','#fae0d1');
            $rows.filter(':nth-child(4),:nth-child(5)').css('background-color','#ebebeb');
            $rows.filter(':nth-child(1)').css('background-color','#e0ebfa');
            $rows.filter(':nth-child(6),:nth-child(13),:nth-child(14)').css('background-color','#ebd9f5');
...
| 🫒 Mild olive oil | 15 g | |
| 🧅 Onion (diced) | 150 g | |
| 🧄 Garlic (pounded, or 2–3 g powder) | 12 g | |
| 🟤 Ground cumin | 3 g | |
| 🔴 Sweet paprika (NOT smoked) | 5 g | |
| 🥦 Broccoli (florets, steamed separately) | 300 g | |
| 🌿 Asparagus (spears, steamed separately) | 250 g | |
| 🫗 Liquid aminos | 30 ml | |
...
![Cooking Timeline](https://www.wolframcloud.com/obj/pirk0/RenderTimeline?steps=%7B%22Ninja%22%3A%7B%22color%22%3A%22%235A8CD1%22%2C%22steps%22%3A%5B%5B0%2C5%2C%22Load%20beans%2C%20squash%2C%20corn%2C%20kombu%22%5D%2C%5B5%2C100%2C%22Heat-up%20%2B%20HP%2025%20min%20%2B%20natural%20release%22%5D%2C%5B106%2C113%2C%22Season%20base%22%5D%5D%7D%2C%22Wok%22%3A%7B%22color%22%3A%22%235AAD5A%22%2C%22steps%22%3A%5B%5B82%2C94%2C%22Sweat%20onion%2C%20bloom%20paprika%22%5D%5D%7D%2C%22Steamer%22%3A%7B%22color%22%3A%22%23D17A3A%22%2C%22steps%22%3A%5B%5B88%2C96%2C%22Steam%20broccoli%20%2B%20asparagus%22%5D%5D%7D%2C%22Blender%22%3A%7B%22color%22%3A%22%23B772B7%22%2C%22steps%22%3A%5B%5B100%2C106%2C%22Blend%20base%20%2B%20backbone%22%5D%5D%7D%7D&syncs=%5B%7B%22t%22%3A100%2C%22color%22%3A%22%231F4D7A%22%2C%22label%22%3A%22Ninja%20done%22%7D%2C%7B%22t%22%3A106%2C%22color%22%3A%22%23595959%22%2C%22label%22%3A%22Blend%20done%22%7D%2C%7B%22t%22%3A113%2C%22color%22%3A%22%23595959%22%2C%22label%22%3A%22Ready%22%7D%5D)
...
*Total values for the whole recipe. **Estimates, not FoodNoms-verified** — computed in Wolfram from standard per-100 g values; replace with FoodNoms totals when next cooked. Naturally creamy and low-fat (27 g fat total) — the body comes from pinto and butternut, not added cream or coconut milk. High fibre (88 g) and folate from the bean-and-vegetable load. Vitamin D and B12 negligible — supplement separately. Salt ~10 g, comfortably inside the 10–15 g family target.*

| Macro | Total | Micro | Total |
|:------|------:|:------|------:|
| Energy | 2162 kcal | Iron | 34 mg |
| Protein | 101 g | Calcium | 1112 mg |
| Carbohydrates | 422 g | Zinc | 14 mg |
| — of which sugars | 60 g | Magnesium | 1113 mg |
| Fat | 27 g | Potassium | 10318 mg |
| — of which saturates | 4 g | Vitamin D | 0.0 µg |
| Fibre | 88 g | Vitamin B12 | 0.0 µg |
| Salt | 10 g | Folate | 2130 µg |
