...
|:--------|:---------------|
| Jannes ≥ 7, adults ≥ 8 | **Hypothesis confirmed**: red miso was the issue. Default to white miso for family meals; reserve red miso for solo/adult cooks |
| Jannes ≥ 7, adults drop | Mixed signal — red miso may have boosted adults specifically; need a third data point |
| Jannes stays at 6 | Something else is the issue (bok choi? Tsuyu intensity? salt level?). Next experiment should isolate further |
