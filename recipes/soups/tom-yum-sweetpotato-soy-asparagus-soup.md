...
*Whole recipe (~3.76 kg of inputs, ~3.25 kg estimated yield). **USDA-derived + labels, not FoodNoms-verified.** 🍠 sweet potato, 🧅 onion, 🍮 silken tofu, 🌿 asparagus and 🍄 mushroom powder from authentic USDA values; 🍲 paste from its label; 🍅 cherry tomatoes valued at USDA generic raw tomato `170457` (a proxy — cherry varieties run a little sweeter). ⚠ **🥛 Soy milk is a committed estimate assuming a fortified unsweetened carton** (33 kcal, 3.3 g protein, 120 mg calcium, B12 and vitamin D added per 100 ml). An unfortified carton would remove roughly 1200 mg of the calcium, 3.8 µg of B12 and 7.5 µg of vitamin D from the totals below — **check the pack**. Micros are committed best-estimates and stand as final.*
